...
class BrandColors {
  ...
  static const Color accent = Color(0xFFF59E0B); // Saffron
  static const Color success = Color(0xFF16A34A); // Emerald

  // Neutrals
  static const Color background = Color(0xFFFFFDF8); // Soft Ivory
  static const Color surface = Colors.white;
  static const Color surfaceTint = Color(0xFFF6F4EE);

  // Text
  static const Color ink = Color(0xFF1F2937); // Charcoal
