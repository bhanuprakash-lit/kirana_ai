        ...
        data: (r) {
          ...
          return ListView(
            ...
            children: [
              ...
              ...r.byStore.asMap().entries.map((e) =>
                  _storeBar(e.key, e.value, maxRev)),
              const SizedBox(height: 20),
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(r.groupName ?? 'My Stores',
                      style: const TextStyle(
                          fontWeight: FontWeight.w900, fontSize: 16)),
                  Text('${r.storeCount} outlets · last ${r.days} days',
                      style: const TextStyle(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor:
                  const AlwaysStoppedAnimation<Color>(BrandColors.primary),
            ),
          ),
          const SizedBox(height: 2),
          Text('${s.area} · ${s.orders} orders · avg ${_money(s.avgBill)}',
  ...
  Widget _areaTile(AreaRow a) => Container(
        ...
        child: Row(
          children: [
            ...
            Text('${a.stores} stores · ${a.orders} orders   ',
                style:
                    const TextStyle(fontSize: 11, color: BrandColors.muted)),
            Text(_money(a.revenue),
                style: const TextStyle(
                    fontWeight: FontWeight.w800, color: BrandColors.success)),
          ],
        ),
      );
}
