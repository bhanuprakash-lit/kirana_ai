  ...
  Widget build(BuildContext context) {
    final faqs = [
      _Faq(
        ...
        answer: 'You can add products from the POS tab by clicking the + button, or from the Inventory tab. You can also scan a barcode to automatically fetch details if available.',
      ),
      _Faq(
        question: 'How does the Stockout Risk prediction work?',
        answer: 'Our AI analyzes your past sales velocity and current stock levels. If it predicts you will run out of an item within the next 3-7 days, it flags it as a Stockout Risk.',
      ),
      _Faq(
      ...
      _Faq(
        ...
        answer: 'KPIs are key business metrics like Revenue, Margin, and Footfall. You can choose which metrics to monitor from the Profile -> Subscription section.',
      ),
       _Faq(
        question: 'How do I generate a daily sales report?',
        answer: 'You can view today\'s performance on the Dashboard. For detailed past reports, visit the Transaction History section in your Profile.',
      ),
    ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('FAQs', style: TextStyle(fontWeight: FontWeight.w800)),
