...
class BusinessAlert {
  ...
  IconData get icon {
    switch (type) {
      case AlertType.lowStock: return Icons.inventory_2_rounded;
  ...
  Color get color {
    switch (priority) {
      case AlertPriority.high: return Colors.red;
      case AlertPriority.medium: return Colors.orange;
      case AlertPriority.low: return Colors.blue;
    }
  }
}
